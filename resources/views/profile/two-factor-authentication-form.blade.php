<x-action-section>
    ...
    <x-slot name="content">
        <h3 class="text-lg font-medium text-gray-900 card-action-section-text">
            @if ($this->enabled)
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600 card-action-section-text-secondary">
            <p>
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600 card-action-section-text-secondary">
